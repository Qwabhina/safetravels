		...
		<div class="modal-content">
			...
			<div class="modal-body" id="route_map">
				...
				<div class="container">
					...
					<center><input style="margin-top:0px;" class="btn cus_button1" type="submit" name="submit" id="btn" value="Verify"></input></center>
				</div>
			</form >
			</div>
			<div class="modal-footer">
...
<nav class="navbar navbar-expand-sm  navbar-light fixed-top" style="background-color:#fff;border-top:px solid #f2f2f2;box-shadow: 0 0 8px #999999;">
		  <a class="navbar-brand" style="color:#079d49;margin-left:1%;font-family:Helvetica;font-weight:bold;" href="index.php">
			...
			<img src='logo.png' style='padding-top:2%;margin-right:5%' class='img-fluid'/>
		  </a>
		  ...
		  <div class="collapse navbar-collapse" style="background-color:white;color:white;z-index:200;width:100%;margin-left:17%;" id="collapsibleNavbar">
				 <ul class="navbar-nav">
				  <li class="nav-item">
					<a class="btn btn-link nav-link" style='color:#079d49;font-size:16px;background-color:white' href="index.php">&emsp;Pick Bus</a>
				  </li>
				  <li class="nav-item">
					<a class="btn btn-link nav-link" style='color:#079d49;font-size:16px;background-color:white' href="index.php">&emsp;Bus Operators</a>
				  </li>
				   <li class="nav-item">
